...
public class GenerateurEmploiDuTemps {
    ...
    private static List<Professeur> saisieProfesseurs() {
        ...
        while (true) {
            ...
            System.out.print("Salle de cours : ");
            String salle = scanner.nextLine();

            professeurs.add(new Professeur(nom, matiere, jour, heure, salle));
        }
    ...
    private static void genererEmploiDuTemps(List<Professeur> professeurs) {
        ...
        try {
            ...
            table.addCell(createCell("Salle du cours", true));
            ...
            for (Professeur professeur : professeurs) {
                ...
                table.addCell(createCell(professeur.getSalle()));
...
class Professeur {
    ...
    public Professeur(String nom, String matiere, String jour, String heure, String salle) {
        this.nom = nom;
